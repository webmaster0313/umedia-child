					...
					<div class="search-page">
						<div class="container px-0">
							<div class="row align-items-center">
								<div class="col-8 col-md-6">
									<div class="titlebar">
										<h1 class="page-title pl-3 pl-sm-0">Search Results</h1>
						...
						<div class="container mobile-wrapper">
							...
							*/
							...
							echo do_shortcode('[ajax_load_more id="my_alm_query_args_relevanssi" search="'. $term .'" post_type="post, page, results, capabilities, news" repeater="template_4" orderby="relevance" posts_per_page="10" scroll="false"  button_label="Load More"]');
							?>
							</div>
						</div><!-- .container -->
						<div class="container">
